...
% 调大标签和标题字号
xlabel('x_w (m)', 'FontName', 'Times New Roman', 'FontSize', 20);
ylabel('y_w (m)', 'FontName', 'Times New Roman', 'FontSize', 20);
title('Trajectory Tracking Performance', 'FontName', 'Times New Roman', 'FontSize', 20);
% 调大坐标轴刻度字号
grid on; axis equal; set(gca, 'FontName', 'Times New Roman', 'FontSize', 12);
...
ylabel('Steering rate (rad/s)', 'FontName', 'Times New Roman', 'FontSize', 20); 
title('Steering Rate of Each Wheel', 'FontName', 'Times New Roman', 'FontSize', 20);
% （已删除 legend）
% 调大坐标轴刻度字号
...
% 调大标签和标题字号
xlabel('Time (s)', 'FontName', 'Times New Roman', 'FontSize', 20); 
ylabel('Output Velocity (m/s)', 'FontName', 'Times New Roman', 'FontSize', 20); 
title('Output Velocity', 'FontName', 'Times New Roman', 'FontSize', 20);
...
prev_phi = zeros(4, 1);
    ...
    for k = 1:params.num_steps
        ...
        psi_history(k) = psi0;
        %================= 耗时统计 ================
        [new_state_dot, velocity, solve_time, iter_num] = control_RSS(path, k, last_vel, state, params);
